        ...
        <tbody>
            @foreach ($customers as $key => $item)
                <tr>
                    ...
                    <td>{{ $item->password }}</td>
                    <td>
                        <img src="{{ asset('public/uploads/customer/' . $item->image) }}" alt="{{ $item->name }}" style="max-width: 100px; max-height: 100px;">
                    </td>
                    <td>
                        <form action="{{ route('customers.destroy', [$item->id]) }}" method="post">
                            ...
                            <a href="{{ route('customers.show', [$item->id]) }}" class="btn btn-warning">Show</a>
