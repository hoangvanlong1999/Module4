...
@section('content')
    ...
    <table class="table" style="text-align:center">
        <a href="{{ route('orderdetails.create') }}" class="btn btn-info">Create</a>
        <thead>
            <tr>
                <th>ID</th>
                <th>order_id</th>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('orderdetails.destroy', [$item->id]) }}" method="post">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('orderdetails.edit', [$item->id]) }}" class="btn btn-success">Edit</a>
                            <a href="{{ route('orderdetails.show', [$item->id]) }}" class="btn btn-warning">Show</a>
